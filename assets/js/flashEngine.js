/* ============================================================================
   ...
   - Cards live in lazy-loaded per-domain modules (assets/js/content/flashN.js),
     each populating SECPLUS.flash[N] with 100 cards { id, d, t, obj, front, back }.
   - Scheduling state persists to localStorage (secplus.flash.v1) keyed by card id,
...
(function () {
  ...
  function ver() { return window.SECPLUS_VER ? "?v=" + window.SECPLUS_VER : ""; }
